...
/**
 * This package contains all classes from the navigation graph / network.
 * As a result of the application there should be a 2D floorplan and a indoor navigation graph.
 */
